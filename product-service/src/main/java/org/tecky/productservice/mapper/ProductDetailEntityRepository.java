...
public interface ProductDetailEntityRepository extends JpaRepository<ProductDetailEntity, String> {
    ...
    public List<ProductDetailEntity> findByGroupIdAndColaValue(@Param("groupId") Integer groupId, @Param("colaValue") String p);
    ...
    public ProductDetailEntity findByGroupIdAndColaValueAndColbValue(@Param("groupId") Integer groupId, @Param("colaValue") String p, @Param("colbValue") String s);
